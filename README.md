...
- 🎨 **Rich animated background** — a full taqueria bar scene with:
  ...
  - 🕐 A working wall clock (shows your actual time!)
...
This is the coolest part: **every single image in this game is made of rectangles.** No photos. No sprite sheets. No image files of any kind. The wrestlers, the neon sign, the rooster, the wall clock — all thousands of tiny colored boxes, carefully stacked and positioned. Learning to "think in rectangles" is a surprisingly powerful skill.
...
That's it. One file. No build process, no dependencies, no install steps.
